...
class CFM13(object):
    ...
    def Write(self, cfm13file, ParsedData):
        ...
        if ('AdditionalData' in ParsedData['DocumentHeaderData']):
            ParsedData['DocumentHeaderData']['AdditionalData'] = SyntaxParser.XMLParser.KeyToAttribute('@meaning','#text',ParsedData['DocumentHeaderData']['AdditionalData'])
        ...
        for alert in Alerts :
            CFM13Alert = SyntaxParser.XMLParser.dict_to_etree({'Alert': alert})
