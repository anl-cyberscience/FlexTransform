...
**Input Files (present in the repo, not the package, download to known location if needed)**
  ...
  - [CFM13 File](./ExampleFiles/SampleInput-CFM13.xml)
...
**Input Files (present in the repo, not the package, download to known location if needed)**
   ...
   - [STIX-TLP File](./ExampleFiles/SampleInput-STIX-TLP.xml)
...
## CSV to STIX-TLP
**Input Files (resent in the repo, not the package, download to known location if needed)**

   - [CSV File](./ExampleFiles/SampleInput-CSV.csv)

**Commands**
```bash
    flext
    --src FlexTransform/ExampleFiles/SampleInput-CSV.csv
    --src-config FlexTransform/FlexTransform/resources/sampleConfigurations/csv_example.cfg
    --dst Output-STIX.xml
    --dst-config FlexTransform/FlexTransform/resources/sampleConfigurations/stix_tlp.cfg
```
