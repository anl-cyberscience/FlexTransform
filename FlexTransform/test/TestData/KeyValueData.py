...
class KeyValueData(object):
    ...
    def __init__(self):
        ...
        self.sample_kv_ipv4_w_domain = "timestamp=1325401200 ipv4=10.11.12.14 fqdn=bad.scanning.dom direction=ingress comment='Attacker scanning for SSH' service=22/TCP category='Scanning' severity=high\r\n"
