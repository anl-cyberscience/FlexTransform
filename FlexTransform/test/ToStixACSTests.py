...
from FlexTransform.test.SampleInputs  import CFM13ALERT, STIXTLP
from FlexTransform import FlexTransform

class TestCFM13AlertToSTIXACS(unittest.TestCase):
    output1 = None
    namespace = {
...
class STIXTLPToSTIXACS(unittest.TestCase):
    ...
    def test_tlp_color(self):
        self.assertEqual(set(self.output1.xpath("//marking:Marking_Structure/edh2:CreateDateTime/@CreateDateTime", namespaces=self.namespace)), set(["2016-04-29T22:01:24+0000"]))

    def test_markingstructure_resposible_entity(self):
        self.assertEqual(set(self.output1.xpath("//marking:Marking_Structure/edh2:CreateDateTime/@CreateDateTime", namespaces=self.namespace)), set(["2016-04-29T22:01:24+0000"]))
